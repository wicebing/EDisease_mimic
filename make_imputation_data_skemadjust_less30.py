...
for random_state in range(5):
    ...
    for i, e in ip_method.items():
        ...
        #============================================================
        try:
            select_lab_keys = ['Cl', 'Ca', 'Glucose', 'Hb', 'Lac', 'Na', 'Crea', 'Mg', 'P', 'K', 'BUN',
                   'Hct', 'PTINR', 'MCH', 'MCHC', 'MCV', 'PLT', 'PTT', 'WBC']
            ...
            filepath = os.path.join(db_file_path, 'data_EDis_imputation', 'skemAdjustLess30', f'{random_state}', f'hadmid_first_lab_{name}.pdpkl')
