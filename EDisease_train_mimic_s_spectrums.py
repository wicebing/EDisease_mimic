...
if task=='train_':
    ...
    mlp = False
    checkpoint_file = f'../checkpoint_EDs_OnlyS/{skemAdjust}/{random_state}/EDisease_spectrum_flat_{spectrum_type}'
    ...
    stc2emb = ED_model.structure_emb(S_config,spectrum_type=spectrum_type)
