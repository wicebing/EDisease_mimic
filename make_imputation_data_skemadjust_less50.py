...
for random_state in range(5):
    ...
    for i, e in ip_method.items():
        ...
        #============================================================
        try:
            select_lab_keys = ['BE', 'Cl', 'Ca', 'Glucose', 'Hb', 'Lac', 'PH', 'Na', 'ALT', 'ALP',
                   'AST', 'BIL-T', 'Crea', 'Mg', 'P', 'K', 'BUN', 'Eosin', 'Hct', 'PTINR',
                   'Lym', 'MCH', 'MCHC', 'MCV', 'Seg', 'PLT', 'PTT', 'WBC']
            ...
            filepath = os.path.join(db_file_path, 'data_EDis_imputation', 'skemAdjustLess50', f'{random_state}', f'hadmid_first_lab_{name}.pdpkl')
